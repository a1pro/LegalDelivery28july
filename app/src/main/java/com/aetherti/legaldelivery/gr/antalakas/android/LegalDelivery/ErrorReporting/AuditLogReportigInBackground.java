...
public class AuditLogReportigInBackground extends AsyncTask<String, String, Boolean> {
	Context context;

	public AuditLogReportigInBackground(Context con) {
		context = con;
	}
	Exception e;
	@Override
	protected void onPreExecute() {
		Toast.makeText(context, "Audits are successfully logged! Sending to Programmer...",
	...
	protected Boolean doInBackground(String... params) {
		...
		GMailSender sender = new GMailSender("texnofeedback@gmail.com",
				"backfeedtexno");
		sender.makeAttachments(strfeedback);
	...
	protected void onPostExecute(Boolean result) {
		if(result)
			Toast.makeText(context, "Auditlog Mailed !", Toast.LENGTH_SHORT).show();
		else
